/*
let w1 = "R8,U5,L5,D3".split(",");
let w2 = "U7,R6,D4,L4".split(",");
...
function SumSteps(posX, posY){

	let stepFrom1 = me1steps[posX+"."+posY];
	let stepFrom2 = me2steps[posX+"."+posY];
	return stepFrom1 + stepFrom2;

}

function Visit(x,y,me,steps){
	let t = x+ "." + y;
	if(s[t] != undefined && s[t] != me){
		common.push([x,y]);
	}
	...
	// Save steps
	if(me == 1 && me1steps[t] == undefined)
		me1steps[t] = steps;
	if(me == 2 && me2steps[t] == undefined)
		me2steps[t] = steps;

}

function RunWire(w, me){
	...
	for( let i = 0; i < w.length; i++){
		...
		let op = w[i];
		let dir = op[0];
		let qty = parseInt( op.substr(1,op.length) );

		if(dir == "R"){
			for(let step = 0; step < qty; step++){
				currX++;
				ii++;
				Visit(currX, currY,me, ii);
			}
		} else if(dir == "L"){
			for(let step = 0; step < qty; step++){
				currX--;
...
let distances = common.map( pos => SumSteps(pos[0], pos[1]) );
console.log(distances);

console.log(Math.min(...distances));

//console.log(me1steps, me2steps)